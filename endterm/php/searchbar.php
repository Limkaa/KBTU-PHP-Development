...
<section class="search">
    <form class="search-form" action="search.php">
        <span>
            <input class="search-form-input depart" name="depart_city_name" type="text" id="depart" autocomplete="off" placeholder="Город отправления" onkeyup="loadData(this.value, 0)" required>
        ...
        <span>
            <input class="search-form-input dest" name="dest_city_name" type="text" id="dest" autocomplete="off"  placeholder="Город прибытия" onkeyup="loadData(this.value, 1)" required>
            <input id="dest_city_id" name="dest_city_id" type="hidden">
            <div class="city-result" id="dest_city_result"></div>
        </span>
        <span>
            <div class="search-form-date">
                <input id="datepicker" name="date" class="search-form-input date" class="search-form-date" autocomplete="off"  type="text" placeholder="Дата туда/обратно" required readonly>
...
<script>
    ...
    function loadData(query, ok){
        if(query.length > 1){
            ...
            ajax_request.open("POST", "php/search_autocomplete.php")
