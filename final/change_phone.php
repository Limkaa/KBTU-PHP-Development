...
?>
    ...
    <body>
        ...
        <div class="welcome-user">
            ...
            <h2>Хотите изменить свой номер телефона?</h2>
            <form class="change-form" action="php/aizar/change_mobile.php" method="post">
                ...
                <label>Ваш старый номер телефона<br>
                    (+7**********)</label>
                <input type="tel" name="old_phone" placeholder="+7">
                <br>

                <label>Ваш новый номер телефона<br>
                    (+7**********)</label>
                <input type="tel" name="new_phone" placeholder="+7">
                <br>
